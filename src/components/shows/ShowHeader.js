    ...
    <div className="show-header row">
      ...
      <div className="show-right column">
          ...
          <div className="row show-existence">
            <h3 className="premiered">Premiered: {premiered}</h3>
            ...
            <p className="show-country extra-detail">Country: {code}</p>
            <p className="show-language extra-detail">Language: {language}</p>
            {networkName && <p className="show-network extra-detail">TV Network: {networkName}</p> }
          </div>
          <div className="show-rating">
            <h3 className={average > 5 ? "good" : "poor" }>
              Ratings: {average ? `${average}/10` : "No Rating"}
              </h3>
            </div>
          ...
          <h4 className={time < 30 ? "show-runtime good" : "show-runtime poor"}>Duration: {runtime} minutes</h4>

          <div className="show-schedule">
            <p className="show-time">Showing time: {time}</p>
